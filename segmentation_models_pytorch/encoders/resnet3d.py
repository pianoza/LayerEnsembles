...
Methods:
    ...
    forward(self, x: torch.Tensor)
        ...
        Output: [f0, f1, f2, f3, f4, f5] - features with corresponding shapes
                [(1, 3, 64, 64, 64), (1, 64, 32, 32, 32), (1, 128, 16, 16, 16), (1, 256, 8, 8, 8),
                (1, 512, 4, 4, 4), (1, 1024, 2, 2, 2)] (C - dim may differ)
...
from ._resnet3d import ResNet3D
from ._resnet3d import BasicBlock
from ._resnet3d import Bottleneck
